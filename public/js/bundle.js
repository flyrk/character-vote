...
var StatesActions = (function () {
  function StatesActions() {
    _classCallCheck(this, StatesActions);

    this.generateActions('getStatesSuccess', 'getStatesFail');
  }

  _createClass(StatesActions, [{
    key: 'getStates',
    value: function getStates() {
      var _this = this;

      $.ajax({ url: '/api/states' }).done(function (data) {
        _this.actions.getStatesSuccess(data);
      }).fail(function (jqXhr) {
        _this.actions.getStatesFail(jqXhr);
      });
    }
  }]);
...
exports['default'] = _alt2['default'].createActions(StatesActions);
module.exports = exports['default'];
...
},{"../actions/AddCharacterActions":1,"../stores/AddCharacterStore":19,"react":"react","react-router":"react-router"}],10:[function(require,module,exports){
'use strict';
...
var Home = (function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    key: 'handlerClick',
    value: function handlerClick(character) {
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement('input', { type: 'text', className: 'form-control', placeholder: this.state.totalCharacters + ' characters', value: this.state.searchQuery, onChange: _actionsNavbarActions2['default'].updateSearchQuery, autoComplete: 'off' }),
              _react2['default'].createElement(
                'span',
...
var _storesStatesStore = require('../stores/StatesStore');

var _storesStatesStore2 = _interopRequireDefault(_storesStatesStore);

var _actionsStatesActions = require('../actions/StatesActions');

var _actionsStatesActions2 = _interopRequireDefault(_actionsStatesActions);
...
var States = (function (_React$Component) {
  ...
  function States(props) {
    ...
    this.state = _storesStatesStore2['default'].getState();
    this.onChange = this.onChange.bind(this);
  }
  ...
  _createClass(States, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      _storesStatesStore2['default'].listen(this.onChange);
      _actionsStatesActions2['default'].getStates();
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _storesStatesStore2['default'].unlisten(this.onChange);
    }
  }, {
    key: 'onChange',
    value: function onChange(state) {
...
},{"../actions/StatesActions":7,"../stores/StatesStore":25,"react":"react"}],17:[function(require,module,exports){
'use strict';
...
exports['default'] = _react2['default'].createElement(
  ...
  _react2['default'].createElement(_reactRouter.Route, { path: '/states', handler: _componentsStates2['default'] }),
...
},{"./components/AddCharacter":9,"./components/App":10,"./components/Character":11,"./components/CharacterList":12,"./components/Home":14,"./components/States":16,"react":"react","react-router":"react-router"}],19:[function(require,module,exports){
'use strict';
...
var CharacterStore = (function () {
  ...
  _createClass(CharacterStore, [{
    ...
    value: function onGetCharacterSuccess(data) {
      ...
      this.isReported = Object.contains(reports, this.characterId);
...
},{"../actions/CharacterActions":2,"../alt":8}],22:[function(require,module,exports){
'use strict';
...
var StatesStore = (function () {
  function StatesStore() {
    ...
    this.bindActions(_actionsStatesActions2['default']);
  ...
  _createClass(StatesStore, [{
    key: 'onGetStatesSuccess',
    value: function onGetStatesSuccess(data) {
      (0, _underscore.assign)(this, data);
    }
  }, {
    key: 'onGetStatesFail',
    value: function onGetStatesFail(jqXhr) {
      toastr.error(jqXhr.responseJSON.message);
    }
  }]);
...
exports['default'] = _alt2['default'].createStore(StatesStore);
module.exports = exports['default'];

},{"../actions/StatesActions":7,"../alt":8,"underscore":"underscore"}]},{},[17]);
