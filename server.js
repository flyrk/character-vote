        ...
        Character.find()
          ...
          .exec(function(err, characters) {
            ...
            let raceCount = _.countBy(characters, function(character) { return character.race; }),
                max = _.max(raceCount, function(race) { return race }),
                inverted = _.invert(raceCount),
                topRace = inverted[max],
                topCount = raceCount[topRace];
        ...
        Character.find()
          ...
          .exec(function(err, characters) {
            ...
            let bloodlineCount = _.countBy(characters, function(character) { return character.bloodline; }),
                max = _.max(bloodlineCount, function(bloodline) { return bloodline }),
                inverted = _.invert(bloodlineCount),
                topBloodline = inverted[max],
                topCount = bloodlineCount[topBloodline];
